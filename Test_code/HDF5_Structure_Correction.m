clear;clc;
expfolder = 'Z:\Chenghang\OPN4SCN\6281_P8_KO_B\';
num_images = 81;

analysis_folder = [expfolder,'analysis\'];
hdf5_input_folder = [analysis_folder 'Elastic_crop_hdf5_backup\'];
...
parfor i = 0:(num_images-1)
    ...
    for j = 1:4
        ...
        for k = 0:1:9999 %iteration through all tracks
            ...
            size_hdf5 = numel(Points_X);
            h5create([hdf5_output_folder,hdf5_name],['/tracks' track_name '/x'],size_hdf5);
            h5write([hdf5_output_folder,hdf5_name],['/tracks' track_name '/x'],Points_X);
            h5create([hdf5_output_folder,hdf5_name],['/tracks' track_name '/y'],size_hdf5);
            h5write([hdf5_output_folder,hdf5_name],['/tracks' track_name '/y'],Points_Y);
            h5create([hdf5_output_folder,hdf5_name],['/tracks' track_name '/z'],size_hdf5);
            h5write([hdf5_output_folder,hdf5_name],['/tracks' track_name '/z'],Points_Z);
