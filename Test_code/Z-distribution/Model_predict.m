...
for i = 1:iteration_num
    ...
    Pixel_intensity_0_temp = sum(A(row_id,(column_id-4):(column_id-1)));
    Pixel_intensity_1_temp = sum(A(row_id,(column_id):(column_id+3)));
    Pixel_intensity_2_temp = sum(A(row_id,(column_id+4):(column_id+7)));
    count_temp_0 = 0;
    count_temp_1 = 0;
    count_temp_2 = 0;
